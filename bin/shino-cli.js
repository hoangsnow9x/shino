...
program
  ...
  .option('-v, --view <engine>', 'add view <engine> support (dust|ejs|hbs|hjs|pug|twig|vash) (defaults to ejs)')
...
function createApplication (name, dir) {
  ...
  copyTemplateMulti('js/controllers', dir + '/App/controllers', '*.js')

  // copy model templates
  mkdir(dir, 'App/models')
  copyTemplateMulti('js/models', dir + '/App/models', '*.js')

  // copy helper templates
  mkdir(dir, 'App/helpers')
  copyTemplateMulti('js/helpers', dir + '/App/helpers', '*.js')

 
  // copy config templates
  mkdir(dir, 'config')
  copyTemplateMulti('js/config', dir + '/config', '*.js')
  ...
  if (program.view) {
    ...
    switch (program.view) {
      case 'dust':
        copyTemplateMulti('views', dir + '/App/views', '*.dust')
        break
      case 'ejs':
        copyTemplateMulti('views', dir + '/App/views', '*.ejs')
        break
      case 'hbs':
        copyTemplateMulti('views', dir + '/App/views', '*.hbs')
        break
      case 'hjs':
        copyTemplateMulti('views', dir + '/App/views', '*.hjs')
        break
      case 'pug':
        copyTemplateMulti('views', dir + '/App/views', '*.pug')
        break
      case 'twig':
        copyTemplateMulti('views', dir + '/App/views', '*.twig')
        break
      case 'vash':
        copyTemplateMulti('views', dir + '/App/views', '*.vash')
        break
    }
  } else {
